...
<header id="contentheader">
    <h1>Area Organizations</h1>
    <a class="submitbutton" href="https://moweaqua.org/submit/submit-an-organization/">Submit/change an organization →</a>
</header>
...
if($currentPost % 2 == 0){
    ...
    if(get_field('phone')){
        echo '<h3>Phone:</h3>';
        echo '<p class="phone">' . get_field('phone') . '</p>';
    }
    if(get_field('email')){
        echo '<h3>Email:</h3>';
